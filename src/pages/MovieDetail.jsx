...
import imdb from "../img/IMDb-Logo-removebg-preview.png";
import { Meteors } from '../components/MeteorDemo/MeteorDemo';
...
const MovieDetail = () => {
    ...
    if (!movie) return <div className="no-movie">No movie found</div>;
